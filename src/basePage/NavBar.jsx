...
export const NavBar = () => {
    ...
    const [docDesplegado, setdocDesplegado] = useState(false);

    const cambiarDocDesplegado = () => {
        if(docDesplegado === true)
        {
            setdocDesplegado(false);
            // return 'is-active';
        }
        if(docDesplegado === false)
        {
            setdocDesplegado(true);
            // return '';
        }
    };
            ...
            <div className="navbar-end">
              <div className="navbar-item">
                <div className="field is-grouped">
                  ...
                  <p className="control">
                    <a className="button is-primary" href="https://github.com/jgthms/bulma/releases/download/1.0.2/bulma-1.0.2.zip">
                      <span className="icon">
